...
async function main() {
    ...
    try {
        var persona = await games.create("Persona 5",["Adventure", "Platform", "Role-playing(RPG)"],["Playstation 3", "Playstation 4"], "/public/images/persona_5.jpeg","Persona 5, a turn-based JRPG with visual novel elements, follows a high school student with a criminal record for a crime he didn't commit. Soon he meets several characters who share similar fates to him, and discovers a metaphysical realm which allows him and his friends to channel their pent-up frustrations into becoming a group of vigilantes reveling in aesthetics and rebellion while fighting corruption.");
        console.log(persona);
    }
    catch(e) {
        console.log(e);
    ...
    try {
        var paperMario = await games.create("Paper Mario: The Thousand-Year Door",["Adventure", "Role-playing(RPG)"],["Nintendo GameCube"], "/public/images/paper_mario.jpeg","What Sleeps Behind the Door? Time passes, the pages turn…and a new chapter unfolds in an unfamiliar land! Get ready for a two-dimensional role-playing adventure for the ages as Mario returns to paper form to discover a mystery that sleeps behind an ancient, legendary portal called the Thousand-Year Door. The quest is long, the dangers many, and this time, Mario will have to make full use of his papery qualities just to survive. Take to the stage! Impressing the crowd builds power for super attacks, but don’t disappoint the audience, or you’ll pay! No need to go it alone! You’ll need to rely on sidekicks to survive, and even enemies have roles to play… Don’t fold under pressure! Fold into a paper airplane, turn sideways to slip through cracks, and much more. Stay on your toes! Stamp foes, swing your hammer, and use timely button presses to do damage!");
    ...
    try {
        var chrono = await games.create("Chrono Trigger",["Role-playing(RPG)"],["Android", "Nintendo DS", "iOS", "Super Famicom", "Super Nintendo Entertainment System (SNES)", "Wii", "PlayStation", "PC"], "/public/images/chrono_trigger.jpeg","In this turn-based Japanese RPG, young Crono must travel through time through a misfunctioning teleporter to rescue his misfortunate companion and take part in an intricate web of past and present perils. The adventure that ensues soon unveils an evil force set to destroy the world, triggering Crono's race against time to change the course of history and bring about a brighter future.");
        console.log(chrono);
    }
    catch(e) {
        console.log(e);
